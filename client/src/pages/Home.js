  ...
  return (
    <div>
      ...
      <p>
        ...
        in React to display data from the Star Wars API (
      ...
      <p>
        The Star Wars API exposes data via Rest and can be called by Any
        Application.
      </p>
      ...
      <p>
        here are some code snippets, just to speed up the development, you don't
        need to use them if you don't want
      </p>
      <code>
        <pre>
          <b>To access the list of people from the star wars api:</b>
          <br />
          <br />
